...
project_retirement <- function(
  ...
  workforce_data_dt <- workforce_data_dt[retirement_date > max(workforce_data_dt[["ref_date"]])]
  ...
  projected_retirement_data <- workforce_data_dt[, .N, by = retirement_date][order(retirement_date)]
